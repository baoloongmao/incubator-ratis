...
public class TestRaftWithGrpc
  ...
  public void testUpdateViaHeartbeat() throws Exception {
    System.err.println("wangjie begin testUpdateViaHeartbeat");
  ...
  void runTestUpdateViaHeartbeat(MiniRaftClusterWithGrpc cluster) throws Exception {
    ...
    try (final RaftClient client = cluster.createClient()) {
      ...
      RaftServerTestUtil.getLogAppenders(cluster.getLeader()).forEach(logAppender ->
        ...
        System.err.println("wangjie follower:" + logAppender.getFollower().getName() +" followerMatchIndex:" + followerMatchIndex + " leaderNextIndex:" + leaderNextIndex
          + " getNextIndex:" + logAppender.getFollower().getNextIndex());
