...
public class TestMetaServer {
    ...
    public static void afterClass() {
        ...
        System.out.println("after class:" + PeerProxyMap.getProxyMap());
    }
...
//        assert(stream.getSize() > 0); //TODO: Doesn't work
    ...
    public void testGetNotExistingLog() throws Exception {
        LogStream log = null;
        try {
            log = client.getLog(LogName.of("no_such_log"));
    ...
    private void createLogAndClose(String name) {
        try (LogStream stream = client.createLog(LogName.of(name))) {
